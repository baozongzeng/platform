        ...
        init: function(options, name) {
            ...
            var gridObject = {
                ...
                constructGrid: function() {
                    ...
                    //获取滚动条宽度
                    var scrollbarWidth = $.fn.dlshouwen.grid.scrollbarWidth;


                    var grid = $('#dlshouwen_grid_' + gridReflectionObj.option.id);

                    $("#grid-style-" + gridReflectionObj.option.id).remove();

                    $(".dlshouwen_grid_loading", grid).show();
                    ...
                    gridContent.push('<div id="dlshouwen_grid_' + gridReflectionObj.option.id + '"><div class="dlshouwen_grid_loading"><div class="dlshouwen_grid_loading_bg"></div><span>Loading</span></div>');
                    if (gridReflectionObj.option.showHeader != false) {
                        var columns = gridReflectionObj.option.columns;
                        gridContent.push('<div id="dlshouwen_grid_header' + gridReflectionObj.option.id + '" class="dlshouwen_grid_header"><table class="dlshouwen-grid ' + gridReflectionObj.option.tableClass + '"  style="' + gridReflectionObj.option.tableStyle + '"><thead>');
                        gridContent.push('  <tr class="dlshouwen-grid-headers">');
                        gridStyle.push('cell-div-extra')
                        if (gridReflectionObj.option.extraWidth != null) {



                            gridReflectionObj.option.extraWidth = (gridReflectionObj.option.extraWidth + "").indexOf('%') != -1 ? gridReflectionObj.option.extraWidth : parseInt(gridReflectionObj.option.extraWidth, 10) + 'px'


                            gridContent.push('  <th class="extra-column ' + extraColumnClass + '" ><div class="th-cell-div cell-div-extra" style="width:' + gridReflectionObj.option.extraWidth + '"></div></th>');
                        } else {

                            gridContent.push('  <th class="extra-column ' + extraColumnClass + '"><div class="th-cell-div cell-div-extra"></div></th>');
                        }
                        if (gridReflectionObj.option.check) {
                            gridStyle.push('cell-div-check')
                            if (gridReflectionObj.option.checkWidth != null) {

                                gridReflectionObj.option.checkWidth = (gridReflectionObj.option.checkWidth + "").indexOf('%') != -1 ? gridReflectionObj.option.checkWidth : parseInt(gridReflectionObj.option.checkWidth, 10) + 'px'


                                gridContent.push('  <th class="check-column" ><div class="th-cell-div cell-div-check" style="width:' + gridReflectionObj.option.checkWidth + '"><input type="checkbox" id="dlshouwen_grid_' + gridReflectionObj.option.id + '_check" value="check"></div></th>');
                            } else {
                                gridContent.push('  <th class="check-column"><div class="th-cell-div cell-div-check"><input type="checkbox" id="dlshouwen_grid_' + gridReflectionObj.option.id + '_check" value="check"></div></th>');
                            }
                        }
                        for (var i = 0; i < columns.length; i++) {

                            gridStyle.push('cell-div-' + i);
                            if (columns[i].width != null) {
                                gridContent.push('  <th  columnNo="' + i + '" columnId="' + columns[i].id + '" class="dlshouwen-grid-header ' + gridReflectionObj.getColumnClassForHide(columns[i]) + ' ' + columns[i].headerClass + ' can-sort" style="' + columns[i].headerStyle + '"><div  has-width="true"  style="width:' + columns[i].width + '" class="th-cell-div cell-div-' + i + '">');
                            } else {
                                gridContent.push('  <th columnNo="' + i + '" columnId="' + columns[i].id + '" class="dlshouwen-grid-header ' + gridReflectionObj.getColumnClassForHide(columns[i]) + ' ' + columns[i].headerClass + ' can-sort" style="' + columns[i].headerStyle + '"><div class="th-cell-div cell-div-' + i + '">');
                            }
                            if (gridReflectionObj.sortParameter && gridReflectionObj.sortParameter.columnId && gridReflectionObj.sortParameter.columnId == columns[i].id) {
                                if (gridReflectionObj.sortParameter.sortType == '1') {
                                    gridContent.push('<span class="dlshouwen-grid-sort">' + $.fn.dlshouwen.grid.lang[gridReflectionObj.option.lang].sortColumn.asc + '</span>');
                                }
                                if (gridReflectionObj.sortParameter.sortType == '2') {
                                    gridContent.push('<span class="dlshouwen-grid-sort dlshouwen-grid-sort-desc">' + $.fn.dlshouwen.grid.lang[gridReflectionObj.option.lang].sortColumn.desc + '</span>');
                                }
                            }
                            gridContent.push('  ' + columns[i].title);
                            gridContent.push('  </div></th>');
                        }
                        gridContent.push('  </tr>');
                        gridContent.push('</thead></table></div>');
                    }
                    //构建表格
                    gridContent.push('<div  id="dlshouwen_grid_body' + gridReflectionObj.option.id + '"  class="dlshouwen_grid_body"><table class="dlshouwen-grid ' + gridReflectionObj.option.tableClass + '"  style="' + gridReflectionObj.option.tableStyle + '">    <tbody>');
                    if (gridReflectionObj.exhibitDatas != null) {
                        ...
                        for (var i = 0; i < gridReflectionObj.exhibitDatas.length; i++) {
                            var cls = i % 2 == 0 ? 'grid-row-even' : 'grid-row-odd';
                            gridContent.push('  <tr class="' + cls + ' dlshouwen-grid-row" dataNo="' + i + '">');
                            if (gridReflectionObj.option.extraWidth != null) {

                                gridReflectionObj.option.extraWidth = (gridReflectionObj.option.extraWidth + "").indexOf('%') != -1 ? gridReflectionObj.option.extraWidth : parseInt(gridReflectionObj.option.extraWidth, 10) + 'px'

                                gridContent.push('  <td class="extra-column extra-column-event ' + extraColumnClass + '"  dataNo="' + i + '"><div style="width:' + gridReflectionObj.option.extraWidth + '"  class="td-cell-div cell-div-extra">' + $.fn.dlshouwen.grid.lang[gridReflectionObj.option.lang].extraColumn.open + '</div></td>');
                            } else {
                                gridContent.push('  <td class="extra-column extra-column-event ' + extraColumnClass + '" dataNo="' + i + '"><div class="td-cell-div cell-div-extra">' + $.fn.dlshouwen.grid.lang[gridReflectionObj.option.lang].extraColumn.open + '</div></td>');
                            }
                            if (gridReflectionObj.option.check) {
                                if (gridReflectionObj.option.checkWidth != null) {
                                    ...
                                    gridContent.push('  <td class="check-column text-center"  ><div style="width:"' + gridReflectionObj.option.checkWidth + '" class="td-cell-div cell-div-check"><input type="checkbox" dataNo="' + i + '" id="dlshouwen_grid_' + gridReflectionObj.option.id + '_check_' + i + '" class="dlshouwen-grid-check" value="' + i + '"></div></td>');
                                } else {
                                    gridContent.push('  <td class="check-column text-center"><div class="td-cell-div cell-div-check"><input type="checkbox" dataNo="' + i + '" id="dlshouwen_grid_' + gridReflectionObj.option.id + '_check_' + i + '" class="dlshouwen-grid-check" value="' + i + '"></div></td>');
                                }
                            }
                            var columns = gridReflectionObj.option.columns;
                            for (var j = 0; j < columns.length; j++) {
                                ...
                                var frozenCls = columns[j].frozen ? 'columns-frozen' : 'columns-normal';
                                if (columns[j].width != null) {

                                    columns[j].width = (columns[j].width + "").indexOf('%') != -1 ? columns[j].width : parseInt(columns[j].width, 10) + 'px';



                                    gridContent.push('  <td  dataNo="' + i + '" columnNo="' + j + '" class="dlshouwen-grid-cell  dl-grid-custom-width ' + gridReflectionObj.getColumnClassForHide(columns[j]) + ' ' + columns[j].columnClass + '" style="' + columns[j].columnStyle + '"><div style="width:' + columns[j].width + '" class="td-cell-div  cell-div-' + j + " " + frozenCls + '"><div class="cell-div-content">');
                                } else {
                                    gridContent.push('  <td dataNo="' + i + '" columnNo="' + j + '" class="dlshouwen-grid-cell ' + gridReflectionObj.getColumnClassForHide(columns[j]) + ' ' + columns[j].columnClass + '" style="' + columns[j].columnStyle + '"><div class="td-cell-div cell-div-' + j + " " + frozenCls + '"><div class="cell-div-content">');
                                }
                                var value = gridReflectionObj.exhibitDatas[i][columns[j].id];
                                value = value == null ? '' : value;
                                if (columns[j].resolution) {
                                    gridContent.push(columns[j].resolution(value, gridReflectionObj.exhibitDatas[i], columns[j], gridReflectionObj, i, j));
                                } else {
                                    gridContent.push(gridReflectionObj.formatContent(columns[j], value));
                                }
                                gridContent.push('  </div></div></td>');
                            }
                            gridContent.push('  </tr>');
                            gridContent.push('  <tr id="dlshouwen_grid_' + gridReflectionObj.option.id + '_extra_columns_' + i + '" class="dlshouwen-grid-extra-columns hidden">');
                            gridContent.push('      <td dataNo="' + i + '" colspan="' + (columns.length + 1 + (gridReflectionObj.option.check ? 1 : 0)) + '"><div class="td-cell-div">');
                            for (var j = 0; j < columns.length; j++) {
                                if (columns[j].extra == false) {
                                    continue;
                                }
                                gridContent.push('      <p dataNo="' + i + '" columnNo="' + j + '" class="dlshouwen-grid-cell ' + gridReflectionObj.getExtraColumnClassForHide(columns[j]) + '">');
                                gridContent.push('          ' + columns[j].title + ' : ');
                                var value = gridReflectionObj.exhibitDatas[i][columns[j].id];
                                value = value == null ? '' : value;
                                if (columns[j].resolution) {
                                    gridContent.push(columns[j].resolution(value, gridReflectionObj.exhibitDatas[i], columns[j], gridReflectionObj, i, j));
                            ...
                            gridContent.push('      </div></td>');
                            gridContent.push('  </tr>');
                        }
                    }
                    gridContent.push('  </tbody></table></div>');
                    ...
                    var gridContainer = $('#' + gridReflectionObj.option.gridContainer);

                    gridContainer.append(gridContent.join(""));
                    ...
                    var grid = $('#dlshouwen_grid_' + gridId);
                    var gridBody = $("#dlshouwen_grid_body" + gridId);
                    var gridHead = $("#dlshouwen_grid_header" + gridId);
                    var gridBodyTds = $(".table tr:eq(0)>td", gridBody);
                    var gridHeadTds = $(".table tr>th", gridHead);




                    var thDiv = gridHeadTds.find(".th-cell-div"),
                        tdDiv = gridBodyTds.find('.td-cell-div');


                        gridBody.addClass('autotable')
                        gridHead.addClass('autotable')



                    var tableHeight = gridBody.children().outerHeight()
                    if (gridReflectionObj.option.height != "auto") {

                        var height = parseInt(gridReflectionObj.option.height, 10);
                        var newHeight = height - gridHead.height();
                        gridBody.css({
                            'maxHeight': newHeight
                        });
                        if (tableHeight > newHeight) {
                            grid.addClass('dlshouwen_grid-scroll')
                        } else {
                            grid.removeClass('dlshouwen_grid-scroll')
                        }

                    }
                    if(gridReflectionObj.option.minHeight != "auto"){
                        var minHeight=parseInt(gridReflectionObj.option.minHeight, 10);
                        var newHeight = minHeight - gridHead.height();
                        gridBody.css({
                            'minHeight':newHeight
                        });
                        if (tableHeight <newHeight) {
                            gridBody.children().outerHeight(newHeight);
                        }
                    }


                    gridBody.off('scroll.go').on('scroll.go', function() {

                        var left = gridBody.scrollLeft();
                        gridHead.scrollLeft(left)
                    });
                    ...
                    function setgridWH() {
                        ...
                        for (var index = 0, j = thDiv.length; index < j; index++) {



                            var _self = thDiv.eq(index),
                                thWidth = _self.outerWidth(),
                                tdWidth = tdDiv.eq(index).outerWidth(),
                                max = Math.max(thWidth, tdWidth)




                            styles.push("#dlshouwen_grid_" + gridId + "  ." + gridStyle[index] + "{width:" + max + "px}");


                            setTimeout(function() {
                                $(".dlshouwen_grid_loading", grid).hide();
                            }, 300);

                        }

                        var styleElement = $("<style id='grid-style-" + gridId + "'>" + styles.join("") + "</style>");

                        styleElement.appendTo(gridContainer)

                        setGridHeadWidth();
                    }

                    function setGridHeadWidth() {

                        var gridHeadWidth = gridBody.outerWidth() - scrollbarWidth;

                        if (grid.hasClass('dlshouwen_grid-scroll')) {
                            gridHead.outerWidth(gridHeadWidth)
                        }
                    }
                    ...
                    setgridWH()
                        ...
                        gridBody.removeClass('autotable')
                        gridHead.removeClass('autotable')

                    $(window).off('resize.setgridWH').on('resize.setgridWH', setGridHeadWidth);





                    var hascroll = grid.hasClass('dlshouwen_grid-scroll')


                    $('#dlshouwen_grid_' + gridId + ' .dlshouwen-grid-row').mouseenter(function(e) {

                        var _self = $(this),
                            forzen = _self.find('.columns-frozen'),
                            forzenDiv = forzen.find('.cell-div-content'),
                            forzenDivHeight = forzenDiv.outerHeight(),
                            frozenDivWidth = forzenDiv.outerWidth();



                        if (forzen.length) {

                            var _selfTD = forzen.parent(),
                                _selfTDWidth = _selfTD.outerWidth(),
                                _selfTDHeight = _selfTD.outerHeight();
                            var sign = forzen.position().left - (gridBody.outerWidth() + gridBody.scrollLeft());
                            if (sign > 0) {


                                var cloneNode = forzenDiv.clone().removeClass('cell-div-content').addClass('cell-div-content-clone');
                                cloneNode.appendTo(forzen)

                                forzen.addClass('be-forzened')
                                forzenDiv.width(_selfTDWidth)

                                if (hascroll) {
                                    forzenDiv.css({
                                        left: -(sign + _selfTDWidth + scrollbarWidth)
                                    })
                                } else {
                                    forzenDiv.css({
                                        left: -(sign + _selfTDWidth)
                                    })
                                }
                        ...
                        setTimeout(function() {
                            forzen.removeClass('be-forzened')
                            forzenDiv.css({
                                left: 'auto'
                            }).width('auto')
                            forzen.find('.cell-div-content-clone').remove();
                    ...
                    if (gridReflectionObj.option.onGridComplete) {
                        ...
                        if (gridReflectionObj.option.fixedHeader) {
                            $.fn.dlshouwen.grid.gridFixedHead(gridReflectionObj)
                        }
                    ...
                    $('#dlshouwen_grid_' + gridId + ' .extra-column-event').click(function(e) {
                        ...
                        if ($('#dlshouwen_grid_' + gridId + '_extra_columns_' + dataNo).hasClass('hidden')) {
                            ...
                            // console.log($.fn.dlshouwen.grid.lang[gridReflectionObj.option.lang].extraColumn.close)
                            $(this).find('.td-cell-div').html($.fn.dlshouwen.grid.lang[gridReflectionObj.option.lang].extraColumn.close);
                            //绑定扩展行展开方法
                            ...
                            $(this).find('.td-cell-div').html($.fn.dlshouwen.grid.lang[gridReflectionObj.option.lang].extraColumn.open);
                            //绑定扩展行关闭方法
                    ...
                    if (gridReflectionObj.option.check) {
                        $('#dlshouwen_grid_' + gridId + '_check').click(function(e) {
                            ...
                            $('input[id*=dlshouwen_grid_' + gridId + '_check_]').prop('checked', $(this).prop('checked'));
                            if (gridReflectionObj.option.onCheck) {
                ...
                constructGridPageBar: function() {
                    ...
                    if (gridReflectionObj.exhibitDatas == null || gridReflectionObj.exhibitDatas.length <= 0) {
                        $("#dlshouwen_grid_" + gridId).addClass('dlshouwen-grid-nodata')
                        ...
                        $("#dlshouwen_grid_" + gridId).removeClass('dlshouwen-grid-nodata')
                        gridStatus.className = 'dlshouwen-grid-pager-status text-primary';
                ...
                showProcessBar: function() {
                    ...
                    $('#dlshouwen_grid_process_bar_top_' + gridReflectionObj.option.id).animate({
                        width: gridReflectionObj.processWidth + '%'
                    }, 200);
                    $('#dlshouwen_grid_process_bar_bottom_' + gridReflectionObj.option.id).animate({
                        width: gridReflectionObj.processWidth + '%'
                    }, 200);
                ...
                fastQuery: function(box) {
                    ...
                    for (var j = 0; j < gridReflectionObj.option.columns.length; j++) {
                        ...
                        content += '<div class="form-group"  column-name=' + column.id + '  fastQuery=' + column.fastQuery + '>';
                        ...
                        if (column.fastQueryType == 'range') {
                            ...
                            column.defaultValue?(content += '        <option value="">' + column.defaultValue + '</option>',codeFlag=true): content += '        <option value="">' + $.fn.dlshouwen.grid.lang[gridReflectionObj.option.lang].fastQuery.codeTableSelectAll + '</option>';
                    ...
                    if (box) {
                        //$('#fast_query_' + gridReflectionObj.option.id + '_modal').show();
                    } else {
                        $('#fast_query_' + gridReflectionObj.option.id + '_modal').modal('show');
                    }
                ...
                doFastQuery: function(form) {
                    ...
                    for (var i = 0; i < elements.length; i++) {
                        ...
                        if ($.fn.dlshouwen.grid.tools.equalsIgnoreCase(element.type, 'text') || $.fn.dlshouwen.grid.tools.equalsIgnoreCase(element.type, 'hidden') || $.fn.dlshouwen.grid.tools.equalsIgnoreCase(element.type, 'textarea') || $.fn.dlshouwen.grid.tools.equalsIgnoreCase(element.type, 'select-one') || $.fn.dlshouwen.grid.tools.equalsIgnoreCase(element.type, 'password')) {
                            if (element.name != "") {
...
(function($) {
    ...
    $(function() {
        $.fn.dlshouwen.grid.scrollbarWidth = (function(doc) {
